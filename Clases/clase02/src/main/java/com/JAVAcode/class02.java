...
public class class02 {
	...
	public static void main(String[] args) {
		 ...
		 * numeroB;
		 * 
		 * if(numeroB != 0) { System.out.println("El resultado es: " + resultado); }
		 ...
		 * } else if (numeroDeDia == 7) {System.out.println("El Dia actual es Domingo");
		 * } else {System.out.println("El Dia que Ingreso no existe"); }
		 */
